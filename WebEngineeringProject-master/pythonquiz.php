...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="form-inline my-2 my-lg-0">
                    ...
                    <button class="btn header-btn-collapse-nav active collapsed"
                        style="background-color: rgba(205, 34, 248, 0.767);" data-toggle="collapse"
                        data-target=".header-nav-main nav" aria-expanded="false"><i class="fas fa-bars"></i>
                    </button>
                </form>
                <?php endif ?>
            </div>
		...
		$fetchqry2 = "UPDATE `pythonquiz` SET `userans`='$userselected' WHERE `id`=$c-1"; 
		$result2 = mysqli_query($con,$fetchqry2);
            ...
            <div class="bump">
                <form>
                    <center><img src="python.jpg" height="200px" width="200px"><?php if($_SESSION['clicks']==0){ ?>
                        <button class="btn btn-primary btn-lg" name="start"
            ...
            <form action="" method="post">
                <table><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `pythonquiz` where id='$c'"; 
		  ...
		  ?>
                    <tr>
                        <td>
                            <h3><?php echo @$row['que'];?></h3>
                        </td>
                    </tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 26){ ?>
                    <tr>
                    ...
                    <tr>
                        <td><input required type="radio" name="userans"
                                value="<?php echo $row['option4'];?>">&nbsp;<?php echo $row['option4']; ?><br></td>
                    </tr>
                    <tr>
                        <td><button class="btn btn-primary" style="background-color: rgba(205, 34, 248, 0.767);"
 ...
 if($_SESSION['clicks']>25){ 
	$qry3 = "SELECT `ans`, `userans` FROM `pythonquiz`;";
